...
export const Searchbar = forwardRef(({state: [{keywords}, setState]}, ref) => {
    ...
    return <form ref={ref} className="relative xl:w-3/4">   
        <input type="search" className="relative w-full p-4 pl-20 text-sm border-none text-gray-900 rounded-md drop-shadow-md" placeholder="Search for a country..." value={keywords} onChange={handleChange} />
